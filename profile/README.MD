...
- **[CMFTool](https://github.com/niemopen/cmftool "A command-line tool for the developers of NIEM-conforming data exchange specifications using the NIEM Common Model Format (CMF).")**
...
- **NIEM API [(repo)](https://github.com/niemopen/niem-api/tree/dev) | [(endpoint documentation)](https://api.niemopen.org/v2/swagger-ui/index.html)
- **NIEM Toolbox** [(repo)](https://github.com/niemopen/niem-toolbox/tree/dev) | [(online tool)](https://niemopen.github.io/niem-toolbox)
